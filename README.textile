...
p. It is also possible to load datasets from csv files in a puredis object.  The puredis object won't output anything while loading except for Redis error messages.
